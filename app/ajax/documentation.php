...
if(isset($_POST["nom"]) && !empty($_POST["nom"])) {
    ...
    try {
        ...
        $emailController->sendContactData($data, $settings);
        $emailController->sendEmailTransactionnel($data, $settings);
    }
    catch (Exception $e) {
