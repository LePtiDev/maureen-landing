...
<html lang="fr">
    ...
    <body class="version-s">
        ...
        <div id="blue-cicle" class="blue-circle"></div>
        ...
        <div class="container-all">
            <nav>
                ...
                <svg class="switch-mode" id="LOGO_ECLIPSE" data-name="LOGO ECLIPSE" xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19">
            ...
            <section>
                <p>
                    I'm Maureen, an artistic director <br>
                    crafting thoughtful <span class="word-hover">identities</span>, custom <br>
                    <span class="word-hover">packaging</span>, and bespoke <span class="word-hover">typefaces</span>. <br>
                    My work delights the senses, sparks <br>
                    wonder, and pushes boundaries.
                </p>

                <a href="#" id="circle-arrow" class="circle-arrow">
                    <svg id="arrow-of-circle" xmlns="http://www.w3.org/2000/svg" width="126" height="126" viewBox="0 0 126 126">
                        <text id="_" data-name="→" transform="translate(126 32) rotate(180)" fill="#fff" font-size="101" font-family="SainteColombe-ExtraLightItalic, Sainte Colombe" font-weight="200" font-style="italic"><tspan x="0" y="0">→</tspan></text>
                    </svg>
                </a>
                ...
                <div id="container-tab" class="container-tab">
                    ...
                    <a id="washable" href="#" class="line">
                        <div class="plus"><img src="images/icons/WHITE_PLUS.svg" alt=""></div>
                        <div class="project">WASHABLE___PRINT</div>
                        <div class="domain">BRANDING</div>
                    </a>
